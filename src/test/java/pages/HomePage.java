...
public class HomePage extends BasePage{
    ...
    //    public By modalCloseBtn = By.xpath("//button[contains(@class, 'modal_modalCloseButton')]");
//public By modalCloseBtn = By.cssSelector("button[class*='modal_modalCloseButton']");
//    public By modalCloseBtn =  By.xpath("//button[@class='popup-modal__close-btn close-btn-outside js--popup-modal__close-btn']");
//    public By modalCloseBtn =  By.xpath("//button[@class='popup-modal__close-btn close-btn-outside js--popup-modal__close-btn']//i[@class='ion-close-round']");
//    public By modalCloseBtn =  By.xpath(" //button[@class='modal_modalCloseButton__y_s5N']//*[name()='svg']//*[name()='path' and contains(@fill-rule,'evenodd')]");
...
//button[@class='popup-modal__close-btn close-btn-outside js--popup-modal__close-btn']//i[@class='ion-close-round']
